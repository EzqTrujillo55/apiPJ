...
/**
 * @ORM\Entity(repositoryClass="App\Repository\OfoPasRepository")
 */
class OfoPas
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Ofertas", mappedBy="OfoPas")
     */
    private $ofertas;
    ...
    public function removeOferta(Ofertas $oferta): self
    {
        if ($this->ofertas->contains($oferta)) {
            ...
            if ($oferta->getOfoPas() === $this) {
                $oferta->setOfoPas(null);
            }
        }
